    ...
    !function(a) {
        ...
        e.VERSION = "1.7.2", e.DEFAULTS = {
            ...
            setSize: function() {
                ...
                if (t(), this.options.header && g.css("padding-top", 0), "auto" === this.options.size) {
                    var u = function() {
                        ...
                        c = g.data("height")) : c = g.height(), f.options.dropupAuto && f.$newElement.toggleClass("dropup", d > e && b - r < c), 
                    ...
                    c = g.data("height")) : c = g.height(), f.options.dropupAuto && this.$newElement.toggleClass("dropup", d > e && b - r < c), 
                    g.css({
            ...
            checkDisabled: function() {
                ...
                this.$button.removeClass("disabled")), this.$button.attr("tabindex") != -1 || this.$element.data("tabindex") || this.$button.removeAttr("tabindex")), 
            ...
            keydown: function(c) {
                ...
                d.length) {
                    ...
                    e != j && e > i && (e = i), e < g && (e = g), e == k && (e = h)) : 40 == c.keyCode && (o.options.liveSearch && (e += 1), 
                    e == -1 && (e = 0), e != j && e < f && (e = f), e > h && (e = h), e == k && (e = g)), 
