angular.module("cgBusy", []), angular.module("cgBusy").factory("_cgBusyTrackerFactory", [ "$timeout", "$q", function(a, b) {
    return function() {
        var c = {};
        c.promises = [], c.delayPromise = null, c.durationPromise = null, c.delayJustFinished = !1, 
        c.reset = function(b) {
        ...
        var d = function(a) {
            ...
            c.promises.indexOf(a) === -1 && (c.promises.push(a), c.callThen(a, function() {
                a.$cgBusyFulfilled = !0, c.promises.indexOf(a) !== -1 && c.promises.splice(c.promises.indexOf(a), 1);
            }, function() {
                a.$cgBusyFulfilled = !0, c.promises.indexOf(a) !== -1 && c.promises.splice(c.promises.indexOf(a), 1);
            }));
        };
        return c.active = function() {
            return !c.delayPromise && (c.delayJustFinished ? (c.delayJustFinished = !1, 0 === c.promises.length && (c.durationPromise = null), 
            c.promises.length > 0) : !!c.durationPromise || c.promises.length > 0);
        }, c;
    };
    ...
    return {
        ...
        link: function(f, g, h, i) {
            var j = g.css("position");
            "static" !== j && "" !== j && "undefined" != typeof j || g.css("position", "relative");
            var k, l, m, n, o, p = e(), q = {
            ...
            angular.extend(q, c), f.$watchCollection(h.cgBusy, function(c) {
                if (c || (c = {
                    promise: null
                ...
                (angular.isArray(c) || p.isPromise(c)) && (c = {
                    promise: c
                }), c = angular.extend(angular.copy(q), c), c.templateUrl || (c.templateUrl = q.templateUrl), 
                angular.isArray(c.promise) || (c.promise = [ c.promise ]), n || (n = f.$new()), 
                n.$message = c.message, angular.equals(p.promises, c.promise) || p.reset({
                    promises: c.promise,
                    delay: c.delay,
                    minDuration: c.minDuration
                }), n.$cgBusyIsActive = function() {
                    return p.active();
                }, k && m === c.templateUrl && o === c.backdrop || (k && k.remove(), l && l.remove(), 
                m = c.templateUrl, o = c.backdrop, d.get(m, {
                    cache: b
                }).success(function(b) {
                    if (c.backdrop = "undefined" == typeof c.backdrop || c.backdrop, c.backdrop) {
                    ...
                    k = a(e)(n), angular.element(k.children()[0]).css("position", "absolute").css("top", 0).css("left", 0).css("right", 0).css("bottom", 0), 
                    g.append(k);
                }).error(function(a) {
