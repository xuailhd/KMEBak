!function(a, b, c) {
    ...
    function g(a, d, e) {
        ...
        function g(a, f, g, h, j, p, q) {
            ...
            function s(b) {
                ...
                function i() {
                    for (var a = 0, b = m.length; a < b; a++) if (m[a] === d) {
                        m.splice(a, 1), h(-1, c, "");
                        break;
                    }
                }
            ...
            throw v ? new Error("No response defined !") : new Error("Unexpected request: " + a + " " + f + "\n" + (u ? "Expected " + u : "No more request expected"));
        }
        function j(a) {
    ...
    function h(a, c, d, e) {
        this.data = d, this.headers = e, this.match = function(c, d, e, f) {
            ...
            return !c || (b.isFunction(c.test) ? c.test(a) : c == a);
    ...
    b.mock = {}, b.mock.$BrowserProvider = function() {
        ...
        }, a.$$checkUrlChange = b.noop, a.cookieHash = {}, a.lastCookieHash = {}, a.deferredFns = [], 
        a.deferredNextId = 0, a.defer = function(b, c) {
            ...
            return b.forEach(a.deferredFns, function(a, b) {
                a.id === d && (e = b);
            }), e !== c && (a.deferredFns.splice(e, 1), !0);
        ...
        this.mode = function(b) {
            switch (b) {
              ...
              case "log":
                var c = [];
                a = function(a) {
                    1 == arguments.length ? c.push(a) : c.push([].slice.call(arguments, 0));
                }, a.errors = c;
                break;
        ...
        this.$get = [ "$rootScope", "$q", function(a, d) {
            ...
            return h.cancel = function(a) {
                ...
                }), d !== c && (e[d].deferred.reject("canceled"), e.splice(d, 1), !0);
            }, h.flush = function(a) {
    ...
    if (b.mock.TzDate = function(a, c) {
        ...
        return c.supported = a.supported, c.flush = function() {
            ...
            for (var a = b.length, c = 0; c < a; c++) b[c]();
            b = [];
        }, c;
    }, b.mock.$AsyncCallbackDecorator = function(a) {
        var c = [], d = function(a) {
            c.push(a);
        };
    ...
    b.mock.clearDataCache = function() {
        ...
        m.prototype.toString = Error.prototype.toString, a.inject = b.mock.inject = function() {
            function a() {
                ...
                for (var f = 0, g = c.length; f < g; f++) try {
    ...
    function g(a, d, e, f) {
        ...
        function j(a, g, h, j, k, q, r) {
            ...
            function t(b) {
                ...
                function i() {
                    for (var a = 0, b = n.length; a < b; a++) if (n[a] === e) {
                        n.splice(a, 1), j(-1, c, "");
                        break;
                    }
                }
            ...
            for (var x, y = -1; x = l[++y]; ) if (x.match(a, g, h, k || {})) {
                if (x.response) (f ? f.defer : o)(t(x)); else {
        ...
        this.$get = [ "$browser", "$rootScope", "$q", "$$q", function(a, d, e, f) {
            ...
            return j.cancel = function(a) {
                ...
                return b.forEach(g, function(b, c) {
                    b.id === a.$$intervalId && (d = c);
                }), d !== c && (g[d].deferred.reject("canceled"), g.splice(d, 1), !0);
            }, j.flush = function(a) {
    ...
    if (b.mock.TzDate = function(a, c) {
        ...
        }), a.decorator("$animate", [ "$delegate", "$$asyncCallback", "$timeout", "$browser", function(a, d, e, f) {
            var g = {
                queue: [],
                cancel: a.cancel,
                enabled: a.enabled,
        ...
        a.decorator("$timeout", b.mock.$TimeoutDecorator), a.decorator("$$rAF", b.mock.$RAFDecorator), 
        a.decorator("$$asyncCallback", b.mock.$AsyncCallbackDecorator), a.decorator("$rootScope", b.mock.$RootScopeDecorator);
    } ]), b.module("ngMockE2E", [ "ng" ]).config([ "$provide", function(a) {
        a.decorator("$httpBackend", b.mock.e2e.$httpBackendDecorator);
    } ]), b.mock.e2e = {}, b.mock.e2e.$httpBackendDecorator = [ "$rootScope", "$timeout", "$delegate", "$browser", g ], 
    b.mock.$RootScopeDecorator = [ "$delegate", function(a) {
        ...
        (a.beforeEach || a.setup)(function() {
            ...
            a.get("$browser").pollFns.length = 0), b.forEach(b.element.fragments, function(a, c) {
                delete b.element.fragments[c];
            }), i.$$lastInstance = null, b.forEach(b.callbacks, function(a, c) {
                delete b.callbacks[c];
            }), b.callbacks.counter = 0;
        ...
        m.prototype.toString = Error.prototype.toString, a.inject = b.mock.inject = function() {
            ...
            return a = !arguments.length || !!a, l() ? b() : b;
        };
    }
