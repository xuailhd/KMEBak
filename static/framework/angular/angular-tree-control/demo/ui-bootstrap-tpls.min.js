...
angular.module("ui.bootstrap.transition", []).factory("$transition", [ "$q", "$timeout", "$rootScope", function(a, b, c) {
    ...
    i.select = a.select = function(e, f) {
        ...
        var b = (k + 1) % j.length;
        if (!a.$currentTransition) return i.select(j[b], "next");
    }, a.prev = function() {
        var b = k - 1 < 0 ? j.length - 1 : k - 1;
        if (!a.$currentTransition) return i.select(j[b], "prev");
    ...
    function d(a, b, c) {
        return 1 === b && c > 28 ? 29 === c && (a % 4 === 0 && a % 100 !== 0 || a % 400 === 0) : 3 !== b && 5 !== b && 8 !== b && 10 !== b || c < 31;
    }
    this.parsers = {};
    var e = {
        yyyy: {
    ...
    this.modes = [ "day", "month", "year" ], angular.forEach([ "formatDay", "formatMonth", "formatYear", "formatDayHeader", "formatDayTitle", "formatMonthTitle", "minMode", "maxMode", "showWeeks", "startingDay", "yearRange" ], function(c, e) {
        i[c] = angular.isDefined(b[c]) ? e < 8 ? d(b[c])(a.$parent) : a.$parent.$eval(b[c]) : h[c];
    ...
    return {
        ...
        link: function(b, c, d, e) {
            ...
            function g(a, b) {
                ...
                for (d.setHours(12); e < b; ) c[e++] = new Date(d), d.setDate(d.getDate() + 1);
                return c;
            }
            function h(a) {
                var b = new Date(a);
    ...
    return {
        ...
        link: function(b, c, d, e) {
            e.step = {
                ...
                for (var c = new Array(12), d = e.activeDate.getFullYear(), f = 0; f < 12; f++) c[f] = angular.extend(e.createDateObject(new Date(d, f, 1), e.formatMonth), {
                    uid: b.uniqueId + "-" + f
                });
    ...
    return {
        ...
        link: function(a, b, c, d) {
            ...
            d.step = {
                ...
                for (var b = new Array(f), c = 0, g = e(d.activeDate.getFullYear()); c < f; c++) b[c] = angular.extend(d.createDateObject(new Date(g + c, 0, 1), d.formatYear), {
                    uid: a.uniqueId + "-" + c
                });
            ...
            return {
                ...
                compile: function(a, b) {
                    ...
                    return function(a, b, d) {
                        ...
                        var t, u, v, w = !!angular.isDefined(o.appendToBody) && o.appendToBody, x = n(void 0), y = angular.isDefined(d[l + "Enable"]), z = function() {
    ...
    function g() {
        ...
        if (c) return a.showMeridian && (12 === b && (b = 0), a.meridian === p[1] && (b += 12)), 
        b;
    }
    function h() {
    ...
    return {
        ...
        link: function(i, j, k, l) {
            ...
            w.$watch("activeIdx", function(a) {
                a < 0 ? j.removeAttr("aria-activedescendant") : j.attr("aria-activedescendant", A(a));
            });
            var B = function(a) {
                var b = {
                    $viewValue: a
            ...
            l.$parsers.unshift(function(a) {
                ...
                0 !== w.matches.length && h.indexOf(a.which) !== -1 && (a.preventDefault(), 40 === a.which ? (w.activeIdx = (w.activeIdx + 1) % w.matches.length, 
