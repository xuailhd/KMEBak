...
+function(a) {
    ...
    b.DEFAULTS = {
        ...
        if (this.$element.trigger(e), !e.isDefaultPrevented()) return d.removeClass("in"), 
    ...
    b.RESET = "affix affix-top affix-bottom", b.DEFAULTS = {
        ...
        if (this.$element.is(":visible")) {
            ...
            var i = !(null != this.unpin && d + this.unpin <= e.top) && (null != h && e.top + this.$element.height() >= c - h ? "bottom" : null != g && d <= g && "top");
            if (this.affixed !== i) {
