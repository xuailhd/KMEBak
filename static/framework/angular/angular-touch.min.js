!function(a, b) {
    ...
    function d(a, c) {
        ...
        this.ngClickOverrideEnabled = function(f) {
            return b.isDefined(f) ? (f && !e && (e = !0, g.$$moduleName = "ngTouch", c.directive("ngClick", g), 
        ...
        return {
            bind: function(b, e, f) {
                ...
                l && b.on(l, function(a) {
                    ...
                    if (k && i) {
                        var c = a(b);
                        if (g += Math.abs(c.x - j.x), h += Math.abs(c.y - j.y), j = c, !(g < d && h < d)) return h > g ? (k = !1, 
    ...
    var g = [ "$parse", "$timeout", "$rootElement", function(a, d, e) {
        ...
        function h(a) {
            if (!(Date.now() - k > p)) {
                ...
                d < 1 && e < 1 || m && m[0] === d && m[1] === e || (m && (m = null), "label" === c(a.target) && (m = [ d, e ]), 
        ...
        return function(c, d, e) {
            ...
            d.on("touchstart", function(a) {
                ...
                m && c < n && t < o && (j(r, s), g && g.blur(), b.isDefined(e.disabled) && e.disabled !== !1 || d.triggerHandler("click", [ a ])), 
                f();
