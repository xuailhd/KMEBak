...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        ...
        pluralCat: function(a, b) {
            var e = 0 | a, f = c(a, b);
            return 1 == e && 0 == f.v ? d.ONE : 0 == f.v && e % 10 >= 2 && e % 10 <= 4 && (e % 100 < 12 || e % 100 > 14) ? d.FEW : 0 == f.v && 1 != e && e % 10 >= 0 && e % 10 <= 1 || 0 == f.v && e % 10 >= 5 && e % 10 <= 9 || 0 == f.v && e % 100 >= 12 && e % 100 <= 14 ? d.MANY : d.OTHER;
        }
    });
} ]);
//# sourceMappingURL=angular-locale_pl-pl.min.js.map
