...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            ERAS: [ "HY", "YY" ],
            FIRSTDAYOFWEEK: 0,
            MONTH: [ "Mweri wo kwanza", "Mweri wo unayeli", "Mweri wo uneraru", "Mweri wo unecheshe", "Mweri wo unethanu", "Mweri wo thanu na mocha", "Mweri wo saba", "Mweri wo nane", "Mweri wo tisa", "Mweri wo kumi", "Mweri wo kumi na moja", "Mweri wo kumi na yel’li" ],
            SHORTDAY: [ "Sab", "Jtt", "Jnn", "Jtn", "Ara", "Iju", "Jmo" ],
            SHORTMONTH: [ "Kwa", "Una", "Rar", "Che", "Tha", "Moc", "Sab", "Nan", "Tis", "Kum", "Moj", "Yel" ],
...
//# sourceMappingURL=angular-locale_mgh.min.js.map
