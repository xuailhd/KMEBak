...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            ERAS: [ "IJ", "IZ" ],
            FIRSTDAYOFWEEK: 0,
            MONTH: [ "Žanwiye", "Feewiriye", "Marsi", "Awiril", "Me", "Žuweŋ", "Žuyye", "Ut", "Sektanbur", "Oktoobur", "Noowanbur", "Deesanbur" ],
            SHORTDAY: [ "Alh", "Ati", "Ata", "Ala", "Alm", "Alz", "Asi" ],
            SHORTMONTH: [ "Žan", "Fee", "Mar", "Awi", "Me", "Žuw", "Žuy", "Ut", "Sek", "Okt", "Noo", "Dee" ],
...
//# sourceMappingURL=angular-locale_ses-ml.min.js.map
