...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            ERAS: [ "BCE", "CE" ],
            FIRSTDAYOFWEEK: 6,
            MONTH: [ "Janaware", "Feberware", "Matšhe", "Aporele", "Mei", "June", "Julae", "Agostose", "Setemere", "Oktobore", "Nofemere", "Disemere" ],
            SHORTDAY: [ "Son", "Mos", "Bed", "Rar", "Ne", "Hla", "Mok" ],
            SHORTMONTH: [ "Jan", "Feb", "Mat", "Apo", "Mei", "Jun", "Jul", "Ago", "Set", "Okt", "Nof", "Dis" ],
            WEEKENDRANGE: [ 5, 6 ],
...
//# sourceMappingURL=angular-locale_nso.min.js.map
