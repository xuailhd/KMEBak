...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            DAY: [ "Kotisap", "Kotaai", "Koaeng’", "Kosomok", "Koang’wan", "Komuut", "Kolo" ],
            ERANAMES: [ "Amait kesich Jesu", "Kokakesich Jesu" ],
            ERAS: [ "AM", "KO" ],
            FIRSTDAYOFWEEK: 0,
            MONTH: [ "Mulgul", "Ng’atyaato", "Kiptaamo", "Iwootkuut", "Mamuut", "Paagi", "Ng’eiyeet", "Rooptui", "Bureet", "Epeeso", "Kipsuunde ne taai", "Kipsuunde nebo aeng’" ],
            SHORTDAY: [ "Kts", "Kot", "Koo", "Kos", "Koa", "Kom", "Kol" ],
            SHORTMONTH: [ "Mul", "Ngat", "Taa", "Iwo", "Mam", "Paa", "Nge", "Roo", "Bur", "Epe", "Kpt", "Kpa" ],
