...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            ERAS: [ "BC", "AD" ],
            FIRSTDAYOFWEEK: 0,
            MONTH: [ "mwezi ya kwanja", "mwezi ya pili", "mwezi ya tatu", "mwezi ya ine", "mwezi ya tanu", "mwezi ya sita", "mwezi ya saba", "mwezi ya munane", "mwezi ya tisa", "mwezi ya kumi", "mwezi ya kumi na moya", "mwezi ya kumi ya mbili" ],
            SHORTDAY: [ "yen", "kwa", "pil", "tat", "ine", "tan", "sit" ],
            SHORTMONTH: [ "mkw", "mpi", "mtu", "min", "mtn", "mst", "msb", "mun", "mts", "mku", "mkm", "mkb" ],
