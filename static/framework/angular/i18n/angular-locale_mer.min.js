...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            ERAS: [ "MK", "NK" ],
            FIRSTDAYOFWEEK: 0,
            MONTH: [ "Januarĩ", "Feburuarĩ", "Machi", "Ĩpurũ", "Mĩĩ", "Njuni", "Njuraĩ", "Agasti", "Septemba", "Oktũba", "Novemba", "Dicemba" ],
            SHORTDAY: [ "KIU", "MRA", "WAI", "WET", "WEN", "WTN", "JUM" ],
            SHORTMONTH: [ "JAN", "FEB", "MAC", "ĨPU", "MĨĨ", "NJU", "NJR", "AGA", "SPT", "OKT", "NOV", "DEC" ],
