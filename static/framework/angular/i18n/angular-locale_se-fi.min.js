...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            SHORTDAY: [ "sotn", "vuos", "maŋ", "gask", "duor", "bear", "láv" ],
            SHORTMONTH: [ "ođđajage", "guovva", "njukča", "cuoŋo", "miesse", "geasse", "suoidne", "borge", "čakča", "golggot", "skábma", "juovla" ],
...
//# sourceMappingURL=angular-locale_se-fi.min.js.map
