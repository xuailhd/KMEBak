...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            ERAS: [ "AK", "PK" ],
            FIRSTDAYOFWEEK: 0,
            MONTH: [ "Mupalangulwa", "Mwitope", "Mushende", "Munyi", "Mushende Magali", "Mujimbi", "Mushipepo", "Mupuguto", "Munyense", "Mokhu", "Musongandembwe", "Muhaano" ],
            SHORTDAY: [ "Mul", "Jtt", "Jnn", "Jtn", "Alh", "Iju", "Jmo" ],
            SHORTMONTH: [ "Mup", "Mwi", "Msh", "Mun", "Mag", "Muj", "Msp", "Mpg", "Mye", "Mok", "Mus", "Muh" ],
