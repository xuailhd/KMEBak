...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            ERAS: [ "BC", "AD" ],
            FIRSTDAYOFWEEK: 0,
            MONTH: [ "ǃKhanni", "ǃKhanǀgôab", "ǀKhuuǁkhâb", "ǃHôaǂkhaib", "ǃKhaitsâb", "Gamaǀaeb", "ǂKhoesaob", "Aoǁkhuumûǁkhâb", "Taraǀkhuumûǁkhâb", "ǂNûǁnâiseb", "ǀHooǂgaeb", "Hôasoreǁkhâb" ],
            SHORTDAY: [ "Son", "Ma", "De", "Wu", "Do", "Fr", "Sat" ],
...
//# sourceMappingURL=angular-locale_naq.min.js.map
