...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            STANDALONEMONTH: [ "januar", "februar", "marec", "april", "maj", "junij", "julij", "avgust", "september", "oktober", "november", "december" ],
            WEEKENDRANGE: [ 5, 6 ],
        ...
        pluralCat: function(a, b) {
            var e = 0 | a, f = c(a, b);
            return 0 == f.v && e % 100 == 1 ? d.ONE : 0 == f.v && e % 100 == 2 ? d.TWO : 0 == f.v && e % 100 >= 3 && e % 100 <= 4 || 0 != f.v ? d.FEW : d.OTHER;
        }
    });
} ]);
//# sourceMappingURL=angular-locale_sl-si.min.js.map
