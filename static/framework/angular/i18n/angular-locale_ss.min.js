...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            ERAS: [ "BCE", "CE" ],
            FIRSTDAYOFWEEK: 6,
            MONTH: [ "Bhimbidvwane", "iNdlovana", "iNdlovu-lenkhulu", "Mabasa", "iNkhwekhweti", "iNhlaba", "Kholwane", "iNgci", "iNyoni", "iMphala", "Lweti", "iNgongoni" ],
            SHORTDAY: [ "Son", "Mso", "Bil", "Tsa", "Ne", "Hla", "Mgc" ],
            SHORTMONTH: [ "Bhi", "Van", "Vol", "Mab", "Nkh", "Nhl", "Kho", "Ngc", "Nyo", "Mph", "Lwe", "Ngo" ],
            WEEKENDRANGE: [ 5, 6 ],
...
//# sourceMappingURL=angular-locale_ss.min.js.map
