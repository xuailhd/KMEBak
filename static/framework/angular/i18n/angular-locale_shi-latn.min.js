...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            ERAS: [ "daɛ", "dfɛ" ],
            FIRSTDAYOFWEEK: 0,
            MONTH: [ "innayr", "bṛayṛ", "maṛṣ", "ibrir", "mayyu", "yunyu", "yulyuz", "ɣuct", "cutanbir", "ktubr", "nuwanbir", "dujanbir" ],
            SHORTDAY: [ "asa", "ayn", "asi", "akṛ", "akw", "asim", "asiḍ" ],
            SHORTMONTH: [ "inn", "bṛa", "maṛ", "ibr", "may", "yun", "yul", "ɣuc", "cut", "ktu", "nuw", "duj" ],
...
//# sourceMappingURL=angular-locale_shi-latn.min.js.map
