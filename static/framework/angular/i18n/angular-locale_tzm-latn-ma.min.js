...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            ERAS: [ "ZƐ", "ḌƐ" ],
            FIRSTDAYOFWEEK: 5,
            MONTH: [ "Yennayer", "Yebrayer", "Mars", "Ibrir", "Mayyu", "Yunyu", "Yulyuz", "Ɣuct", "Cutanbir", "Kṭuber", "Nwanbir", "Dujanbir" ],
            SHORTDAY: [ "Asa", "Ayn", "Asn", "Akr", "Akw", "Asm", "Asḍ" ],
            SHORTMONTH: [ "Yen", "Yeb", "Mar", "Ibr", "May", "Yun", "Yul", "Ɣuc", "Cut", "Kṭu", "Nwa", "Duj" ],
...
//# sourceMappingURL=angular-locale_tzm-latn-ma.min.js.map
