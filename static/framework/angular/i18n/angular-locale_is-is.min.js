...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            SHORTDAY: [ "sun.", "mán.", "þri.", "mið.", "fim.", "fös.", "lau." ],
            SHORTMONTH: [ "jan.", "feb.", "mar.", "apr.", "maí", "jún.", "júl.", "ágú.", "sep.", "okt.", "nóv.", "des." ],
        ...
        pluralCat: function(a, b) {
            var f = 0 | a, g = c(a, b), h = d(g.v, g.f);
            return 0 == h.t && f % 10 == 1 && f % 100 != 11 || 0 != h.t ? e.ONE : e.OTHER;
        }
    });
} ]);
