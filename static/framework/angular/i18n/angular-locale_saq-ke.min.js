...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            ERAS: [ "KK", "BK" ],
            FIRSTDAYOFWEEK: 0,
            MONTH: [ "Lapa le obo", "Lapa le waare", "Lapa le okuni", "Lapa le ong’wan", "Lapa le imet", "Lapa le ile", "Lapa le sapa", "Lapa le isiet", "Lapa le saal", "Lapa le tomon", "Lapa le tomon obo", "Lapa le tomon waare" ],
            SHORTDAY: [ "Are", "Kun", "Ong", "Ine", "Ile", "Sap", "Kwe" ],
            SHORTMONTH: [ "Obo", "Waa", "Oku", "Ong", "Ime", "Ile", "Sap", "Isi", "Saa", "Tom", "Tob", "Tow" ],
            STANDALONEMONTH: [ "Lapa le obo", "Lapa le waare", "Lapa le okuni", "Lapa le ong’wan", "Lapa le imet", "Lapa le ile", "Lapa le sapa", "Lapa le isiet", "Lapa le saal", "Lapa le tomon", "Lapa le tomon obo", "Lapa le tomon waare" ],
            WEEKENDRANGE: [ 5, 6 ],
...
//# sourceMappingURL=angular-locale_saq-ke.min.js.map
