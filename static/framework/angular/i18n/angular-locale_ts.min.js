...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            ERAS: [ "BCE", "CE" ],
            FIRSTDAYOFWEEK: 6,
            MONTH: [ "Sunguti", "Nyenyenyani", "Nyenyankulu", "Dzivamisoko", "Mudyaxihi", "Khotavuxika", "Mawuwani", "Mhawuri", "Ndzhati", "Nhlangula", "Hukuri", "N’wendzamhala" ],
            SHORTDAY: [ "Son", "Mus", "Bir", "Har", "Ne", "Tlh", "Mug" ],
            SHORTMONTH: [ "Sun", "Yan", "Kul", "Dzi", "Mud", "Kho", "Maw", "Mha", "Ndz", "Nhl", "Huk", "N’w" ],
            WEEKENDRANGE: [ 5, 6 ],
...
//# sourceMappingURL=angular-locale_ts.min.js.map
