...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            STANDALONEMONTH: [ "Enero", "Pebrero", "Marso", "Abril", "Mayo", "Hunyo", "Hulyo", "Agosto", "Setyembre", "Oktubre", "Nobyembre", "Disyembre" ],
            WEEKENDRANGE: [ 5, 6 ],
        ...
        pluralCat: function(a, b) {
            var e = 0 | a, f = c(a, b);
            return 0 == f.v && (1 == e || 2 == e || 3 == e) || 0 == f.v && e % 10 != 4 && e % 10 != 6 && e % 10 != 9 || 0 != f.v && f.f % 10 != 4 && f.f % 10 != 6 && f.f % 10 != 9 ? d.ONE : d.OTHER;
        }
    });
} ]);
//# sourceMappingURL=angular-locale_fil.min.js.map
