...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            ERAS: [ "BCE", "CE" ],
            FIRSTDAYOFWEEK: 6,
            MONTH: [ "Phando", "Luhuhi", "Ṱhafamuhwe", "Lambamai", "Shundunthule", "Fulwi", "Fulwana", "Ṱhangule", "Khubvumedzi", "Tshimedzi", "Ḽara", "Nyendavhusiku" ],
            SHORTDAY: [ "Swo", "Mus", "Vhi", "Rar", "Ṋa", "Ṱan", "Mug" ],
            SHORTMONTH: [ "Pha", "Luh", "Ṱhf", "Lam", "Shu", "Lwi", "Lwa", "Ṱha", "Khu", "Tsh", "Ḽar", "Nye" ],
            WEEKENDRANGE: [ 5, 6 ],
...
//# sourceMappingURL=angular-locale_ve-za.min.js.map
