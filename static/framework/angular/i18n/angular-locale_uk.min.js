...
angular.module("ngLocale", [], [ "$provide", function(a) {
    ...
    a.value("$locale", {
        DATETIME_FORMATS: {
            ...
            SHORTMONTH: [ "січ.", "лют.", "бер.", "квіт.", "трав.", "черв.", "лип.", "серп.", "вер.", "жовт.", "лист.", "груд." ],
        ...
        pluralCat: function(a, b) {
            var e = 0 | a, f = c(a, b);
            return 0 == f.v && e % 10 == 1 && e % 100 != 11 ? d.ONE : 0 == f.v && e % 10 >= 2 && e % 10 <= 4 && (e % 100 < 12 || e % 100 > 14) ? d.FEW : 0 == f.v && e % 10 == 0 || 0 == f.v && e % 10 >= 5 && e % 10 <= 9 || 0 == f.v && e % 100 >= 11 && e % 100 <= 14 ? d.MANY : d.OTHER;
        }
    });
} ]);
