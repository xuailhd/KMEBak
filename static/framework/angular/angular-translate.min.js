!function(a, b) {
    ...
    function c(a, b, c, d) {
        ...
        var J = function(a, b) {
            ...
            for (var b = [], c = angular.lowercase(a), d = 0, e = u.length; d < e; d++) b.push(angular.lowercase(u[d]));
            if (J(b, c) > -1) return a;
            if (f) {
                var g;
                for (var h in f) {
                    ...
                    J(b, angular.lowercase(g)) > -1)) return g;
                }
            }
            if (a) {
                var k = a.split("_");
                if (k.length > 1 && J(b, angular.lowercase(k[0])) > -1) return k[0];
            }
            return a;
        }, M = function(a, b) {
            if (!a && !b) return t;
        ...
        var N = function(a, b, c, d) {
            var e, f, g, h;
            b || (b = []), c || (c = {});
            for (e in a) Object.prototype.hasOwnProperty.call(a, e) && (h = a[e], angular.isObject(h) ? N(h, b.concat(e), c, e) : (f = b.length ? "" + b.join(A) + A + e : e, 
            b.length && e === d && (g = "" + b.join(A), c[g] = "@:" + f), c[f] = h));
            return c;
        };
        ...
        var P = function(a) {
            ...
            g = a), angular.isString(e) && J(g, e) < 0 && g.push(e), this) : h ? g[0] : g;
        };
        this.use = function(a) {
            if (a) {
        ...
        this.storageKey = Q, this.useUrlLoader = function(a, b) {
            ...
            var f, l, u, E = b.get(n || "$translateDefaultInterpolation"), F = !1, H = {}, I = {}, R = function(a, b, c, h) {
                if (angular.isArray(a)) {
                    var j = function(a) {
                        for (var e = {}, f = [], g = function(a) {
                            ...
                            return R(a, b, c, h).then(g, g), f.promise;
                        }, i = 0, j = a.length; i < j; i++) f.push(g(a[i]));
                ...
                if (n) {
                    var o = function() {
                        ca(a, b, c, h).then(m.resolve, m.reject);
                    };
            ...
            var W = function(a) {
                ...
                if (h && Object.prototype.hasOwnProperty.call(h, a)) {
                    var k = h[a];
                    "@:" === k.substr(0, 2) ? R(k.substr(2), b, c, e).then(f.resolve, f.reject) : f.resolve(j.interpolate(k, b));
                } else {
                    var l;
                    m && !F && (l = Z(a, b)), i && g && g.length ? aa(a, b, j, e).then(function(a) {
                        f.resolve(a);
                    }, function(a) {
                        f.reject(S(a));
                    }) : m && !F && l ? e ? f.resolve(e) : f.resolve(l) : e ? f.resolve(e) : f.reject(S(a));
                }
                return f.promise;
            }, da = function(a, b, c) {
                var d, e = i ? t[i] : t, f = E;
                if (H && Object.prototype.hasOwnProperty.call(H, c) && (f = H[c]), e && Object.prototype.hasOwnProperty.call(e, a)) {
                    var h = e[a];
                    d = "@:" === h.substr(0, 2) ? da(h.substr(2), b, c) : f.interpolate(h, b);
                } else {
                    var j;
                    m && !F && (j = Z(a, b)), i && g && g.length ? (l = 0, d = ba(a, b, f)) : d = m && !F && j ? j : S(a);
                }
                return d;
            }, ea = function(a) {
            ...
            R.preferredLanguage = function(a) {
                ...
                if (void 0 !== a && null !== a) {
                    if (P(a), o && g && g.length) for (var b = 0, c = g.length; b < c; b++) I[g[b]] || (I[g[b]] = U(g[b]));
                    R.use(R.use());
                }
                return h ? g[0] : g;
                ...
                if (c.$emit("$translateRefreshStart", {
                    ...
                    var j = [], k = {};
                    if (g && g.length) for (var l = 0, m = g.length; l < m; l++) j.push(U(g[l])), k[g[l]] = !0;
                    i && !k[i] && j.push(U(i));
                    var n = function(a) {
                ...
                return f.promise;
            }, R.instant = function(a, b, c) {
                if (null === a || angular.isUndefined(a)) return a;
                if (angular.isArray(a)) {
                    for (var d = {}, f = 0, h = a.length; f < h; f++) d[a[f]] = R.instant(a[f], b, c);
                    return d;
                }
                ...
                for (var l = 0, n = k.length; l < n; l++) {
                    var o = k[l];
                    if (t[o] && ("undefined" != typeof t[o][a] ? j = da(a, b, c) : (q || r) && (j = S(a))), 
                    "undefined" != typeof j) break;
                }
                return j || "" === j || (j = E.interpolate(a, b), m && !F && (j = Z(a, b))), j;
            ...
            fa.promise.then(function() {
                ...
                var b = d.defer();
                return angular.isFunction(a) && b.promise.then(a), B ? b.resolve() : fa.promise.then(b.resolve), 
                b.promise;
            };
            ...
            compile: function(b, i) {
                ...
                return function(b, o, p) {
                    ...
                    var y = function() {
                        ...
                        c ? (g && "." === c.charAt(0) && (c = g + c), a(c, e, k, f).then(function(a) {
                            A(a, d, !0, b);
                        }, function(a) {
                            A(a, d, !1, b);
                        })) : A(c, d, !1, b);
        ...
        return {
            compile: function(b) {
                ...
                return a.onReady(function() {
                    ...
                    f.translateCloak && f.translateCloak.length && f.$observe("translateCloak", function(b) {
                        a(b).then(d, c);
                    });
                };
            }
    ...
    return angular.module("pascalprecht.translate", [ "ng" ]).run(a), a.$inject = [ "$translate" ], 
    ...
    d.$inject = [ "$interpolate", "$translateSanitization" ], d.displayName = "$translateDefaultInterpolation", 
    angular.module("pascalprecht.translate").constant("$STORAGE_KEY", "NG_TRANSLATE_LANG_KEY"), 
    angular.module("pascalprecht.translate").directive("translate", e), e.$inject = [ "$translate", "$q", "$interpolate", "$compile", "$parse", "$rootScope" ], 
    e.displayName = "translateDirective", angular.module("pascalprecht.translate").directive("translateCloak", g), 
    g.$inject = [ "$translate" ], g.displayName = "translateCloakDirective", angular.module("pascalprecht.translate").directive("translateNamespace", h), 
    h.displayName = "translateNamespaceDirective", angular.module("pascalprecht.translate").filter("translate", i), 
    i.$inject = [ "$parse", "$translate" ], i.displayName = "translateFilterFactory", 
    angular.module("pascalprecht.translate").factory("$translationCache", j), j.$inject = [ "$cacheFactory" ], 
    j.displayName = "$translationCache", "pascalprecht.translate";
});
