!function(a, b) {
    ...
    function f(b, c) {
        ...
        for (var e = k.firstChild; e; ) {
            ...
            var f;
            if (!(f = e.firstChild) && (1 == e.nodeType && c.end(e.nodeName.toLowerCase()), 
            f = e.nextSibling, !f)) for (;null == f && (e = e.parentNode, e !== k); ) f = e.nextSibling, 
            1 == e.nodeType && c.end(e.nodeName.toLowerCase());
            e = f;
        }
    ...
    function i(a, c) {
        ...
        return {
            start: function(a, f) {
                ...
                a = b.lowercase(a), d || w[a] !== !0 || o[a] === !0 || (e("</"), e(a), e(">")), 
                a == d && (d = !1);
            },
            chars: function(a) {
                d || e(h(a));
    ...
    function j(b) {
        if (b.nodeType === a.Node.ELEMENT_NODE) for (var c = b.attributes, d = 0, e = c.length; d < e; d++) {
            ...
            "xmlns:ns1" !== g && 0 !== g.indexOf("ns1:") || (b.removeAttributeNode(f), d--, 
            e--);
        }
        var h = b.firstChild;
    ...
    !function(a) {
        ...
        return function(h, i, j) {
            ...
            function l(a, c) {
                ...
                !b.isDefined(i) || "target" in j || q.push('target="', i, '" '), q.push('href="', a.replace(/"/g, "&quot;"), '">'), 
                k(c), q.push("</a>");
            }
            if (null == h || "" === h) return h;
            if (!g(h)) throw f("notstring", "Expected string but received: {0}", h);
            for (var m, n, o, p = h, q = []; m = p.match(c); ) n = m[0], m[2] || m[4] || (n = (m[3] ? "http://" : "mailto:") + n), 
            o = m.index, k(p.substr(0, o)), l(n, m[0].replace(e, "")), p = p.substring(o + m[0].length);
            return k(p), a(q.join(""));
        };
    } ]);
