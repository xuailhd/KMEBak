(function(b) {
    ...
    b.fn.bxSlider = function(s) {
        ...
        var C = function() {
            ...
            j.minThreshold = (j.settings.minSlides * j.settings.slideWidth)
                    + ((j.settings.minSlides - 1) * j.settings.slideMargin);
            j.maxThreshold = (j.settings.maxSlides * j.settings.slideWidth)
                    + ((j.settings.maxSlides - 1) * j.settings.slideMargin);
            j.working = false;
            j.controls = {};
            j.interval = null;
        ...
        var o = function() {
            ...
            if (j.viewport.css("box-sizing") == "border-box") {
                R += parseFloat(j.viewport.css("padding-top")) + parseFloat(j.viewport.css("padding-bottom"))
                        + parseFloat(j.viewport.css("border-top-width"))
                        + parseFloat(j.viewport.css("border-bottom-width"))
            } else {
        ...
        var L = function() {
            ...
            if (j.settings.slideWidth > 0) {
                if (j.settings.mode == "horizontal") {
                    R = (j.settings.maxSlides * j.settings.slideWidth)
                            + ((j.settings.maxSlides - 1) * j.settings.slideMargin)
                } else {
        ...
        var D = function() {
            ...
            if (j.settings.slideWidth == 0 || (j.settings.slideWidth > R && !j.carousel)
                    || j.settings.mode == "vertical") {
                S = R
            } else {
        ...
        var B = function(T, S, U, W) {
            if (j.usingCSS) {
                var V = j.settings.mode == "vertical" ? "translate3d(0, " + T + "px, 0)" : "translate3d(" + T
                        + "px, 0, 0)";
        ...
        var K = function() {
            j.controls.start = b('<div class="bx-controls-auto-item"><a class="bx-start" href="">'
                    + j.settings.startText + "</a></div>");
            j.controls.stop = b('<div class="bx-controls-auto-item"><a class="bx-stop" href="">' + j.settings.stopText
                    + "</a></div>");
...
//                H.stopAuto()
        ...
        H.goToSlide = function(V, X) {
            ...
            if (j.settings.mode == "fade") {
                ...
                j.children.eq(j.active.index).css("zIndex", j.settings.slideZIndex + 1).fadeIn(j.settings.speed,
                        function() {
                ...
                if (!j.settings.infiniteLoop && j.carousel && j.active.last) {
                    ...
                    if (j.carousel && j.active.last && X == "prev") {
                        var Z = j.settings.moveSlides == 1 ? j.settings.maxSlides - q() : ((v() - 1) * q())
                                - (j.children.length - j.settings.maxSlides);
        ...
        H.destroySlider = function() {
            ...
            j.children.each(function() {
                b(this).data("origStyle") != undefined ? b(this).attr("style", b(this).data("origStyle")) : b(this)
                        .removeAttr("style")
            });
            b(this).data("origStyle") != undefined ? this.attr("style", b(this).data("origStyle")) : b(this)
                    .removeAttr("style");
