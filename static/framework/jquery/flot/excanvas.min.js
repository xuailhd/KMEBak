document.createElement("canvas").getContext || !function() {
    ...
    function i(a, b) {
        for (var c = h(), d = 0; d < 3; d++) for (var e = 0; e < 3; e++) {
            for (var f = 0, g = 0; g < 3; g++) f += a[d][g] * b[g][e];
            c[d][e] = f;
        }
        return c;
    }
    ...
    function n(a) {
        var b, c, d, e, f, g;
        if (e = parseFloat(a[0]) / 360 % 360, e < 0 && e++, f = m(l(a[1]), 0, 1), g = m(l(a[2]), 0, 1), 
        0 == f) b = c = d = g; else {
            var h = g < .5 ? g * (1 + f) : g + f - g * f, i = 2 * g - h;
            b = o(i, h, e + 1 / 3), c = o(i, h, e), d = o(i, h, e - 1 / 3);
        }
        return "#" + Q[Math.floor(255 * b)] + Q[Math.floor(255 * c)] + Q[Math.floor(255 * d)];
    }
    function o(a, b, c) {
        return c < 0 && c++, c > 1 && c--, 6 * c < 1 ? a + 6 * (b - a) * c : 2 * c < 1 ? b : 3 * c < 2 ? a + (b - a) * (2 / 3 - c) * 6 : a;
    }
    function p(a) {
        if (a in U) return U[a];
        var b, c = 1;
        if (a = String(a), "#" == a.charAt(0)) b = a; else if (/^rgb/.test(a)) {
            for (var d, e = k(a), b = "#", f = 0; f < 3; f++) d = e[f].indexOf("%") != -1 ? Math.floor(255 * l(e[f])) : +e[f], 
            b += Q[m(d, 0, 255)];
            c = +e[3];
        } else if (/^hsl/.test(a)) {
            var e = k(a);
    ...
    function r(a, b) {
        ...
        return "number" == typeof a.size ? c.size = a.size : a.size.indexOf("px") != -1 ? c.size = f : a.size.indexOf("em") != -1 ? c.size = e * f : a.size.indexOf("%") != -1 ? c.size = e / 100 * f : a.size.indexOf("pt") != -1 ? c.size = f / .75 : c.size = e, 
        c.size *= .981, c;
    }
    function s(a) {
    ...
    function w(a, b) {
        ...
        f < 1 && (e *= f), b.push("<g_vml_:stroke", ' opacity="', e, '"', ' joinstyle="', a.lineJoin, '"', ' miterlimit="', a.miterLimit, '"', ' endcap="', t(a.lineCap), '"', ' weight="', f, 'px"', ' color="', d, '" />');
    }
    function x(a, b, c, d) {
        ...
        if (e instanceof B) {
            ...
            if ("gradient" == e.type_) {
                ...
                j = 180 * Math.atan2(u, v) / Math.PI, j < 0 && (j += 360), j < 1e-6 && (j = 0);
            } else {
            ...
            for (var z = x.length, A = x[0].color, D = x[z - 1].color, E = x[0].alpha * a.globalAlpha, F = x[z - 1].alpha * a.globalAlpha, H = [], I = 0; I < z; I++) {
                var J = x[I];
    ...
    P.init();
    for (var Q = [], R = 0; R < 16; R++) for (var S = 0; S < 16; S++) Q[16 * R + S] = R.toString(16) + S.toString(16);
    var T = {
        aliceblue: "#F0F8FF",
        antiquewhite: "#FAEBD7",
        aquamarine: "#7FFFD4",
    ...
    Y.clearRect = function() {
        ...
        d = arguments[2], g = h = 0, i = e = m, j = f = n; else if (5 == arguments.length) c = arguments[1], 
        d = arguments[2], e = arguments[3], f = arguments[4], g = h = 0, i = m, j = n; else {
            if (9 != arguments.length) throw Error("Invalid number of arguments");
            g = arguments[1], h = arguments[2], i = arguments[3], j = arguments[4], c = arguments[5], 
            d = arguments[6], e = arguments[7], f = arguments[8];
        }
