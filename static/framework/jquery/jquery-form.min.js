!function(a) {
    ...
    a.fn.attr2 = function() {
        ...
        if (b.success = function(a, c, d) {
            for (var e = b.context || this, f = 0, g = s.length; f < g; f++) s[f].apply(e, [ a, c, d || l, l ]);
        }, b.error) {
            var u = b.error;
        ...
        var j, k, l, m, n, o, p;
        for (j = 0, o = i.length; j < o; j++) if (n = i[j], l = n.name, l && !n.disabled) if (b && g.clk && "image" == n.type) g.clk == n && (d.push({
            name: l,
            value: a(n).val(),
            type: n.type
        }), d.push({
