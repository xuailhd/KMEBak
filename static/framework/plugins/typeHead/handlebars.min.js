    ...
    var a = function() {
        ...
        function d(a) {
            a.registerHelper("helperMissing", function(a) {
                if (2 !== arguments.length) throw new Error("Missing helper: '" + a + "'");
                ...
                if (m(a) && (a = a.call(this)), b.data && (c = q(b.data)), a && "object" == typeof a) if (l(a)) for (var h = a.length; f < h; f++) c && (c.index = f, 
                ...
                if (m(a) && (a = a.call(this)), !g.isEmpty(a)) return b.fn(a);
        ...
        var b, c = a, d = {
            ProgramNode: function(a, b, c) {
                this.type = "program", this.statements = a, this.strip = {}, c ? (this.inverse = new d.ProgramNode(c, b), 
                this.strip.right = b.left) : b && (this.strip.left = b.right);
            },
            MustacheNode: function(a, b, c, d) {
                if (this.type = "mustache", this.hash = b, this.strip = d, null != c && c.charAt) {
                    var e = c.charAt(3) || c.charAt(2);
                    this.escaped = "{" !== e && "&" !== e;
                } else this.escaped = !!c;
                var f = this.id = a[0], g = this.params = a.slice(1), h = this.eligibleHelper = f.isSimple;
                this.isHelper = h && (g.length || b);
            },
            PartialNode: function(a, b, c) {
                this.type = "partial", this.partialName = a, this.context = b, this.strip = c;
            },
            BlockNode: function(a, b, d, e) {
                if (a.id.original !== e.path.original) throw new c(a.id.original + " doesn't match " + e.path.original);
                this.type = "block", this.mustache = a, this.program = b, this.inverse = d, this.strip = {
                    left: a.strip.left,
                    right: e.strip.right
                }, (b || d).strip.left = a.strip.right, (d || b).strip.right = e.strip.left, d && !b && (this.isInverse = !0);
            },
            ...
            IdNode: function(a) {
                this.type = "ID";
                for (var b = "", d = [], e = 0, f = 0, g = a.length; f < g; f++) {
                    var h = a[f].part;
                    if (b += (a[f].separator || "") + h, ".." === h || "." === h || "this" === h) {
                        if (d.length > 0) throw new c("Invalid path: " + b);
                        ".." === h ? e++ : this.isScoped = !0;
                    } else d.push(h);
                }
                this.original = b, this.parts = d, this.string = d.join("."), this.depth = e, this.isSimple = 1 === a.length && !this.isScoped && 0 === e, 
        ...
        var a, b = function() {
            ...
            var c = {
                ...
                performAction: function(b, c, d, e, f, g, h) {
                    ...
                    switch (f) {
                      case 1:
                        return new e.ProgramNode(g[i - 1]);

                      case 2:
                        return new e.ProgramNode([]);

                      case 3:
                        this.$ = new e.ProgramNode([], g[i - 1], g[i]);
                        break;

                      case 4:
                        this.$ = new e.ProgramNode(g[i - 2], g[i - 1], g[i]);
                        break;
                      ...
                      case 17:
                        this.$ = new e.MustacheNode(g[i - 1][0], g[i - 1][1], g[i - 2], a(g[i - 2], g[i]));
                        break;
                      ...
                      case 22:
                        this.$ = new e.PartialNode(g[i - 2], g[i - 1], a(g[i - 3], g[i]));
                        break;
        ...
        function c() {}
        var d, e = a.COMPILER_REVISION, f = a.REVISION_CHANGES, g = a.log;
        c.prototype = {
            nameLookup: function(a, b) {
                var d, e;
                return 0 === a.indexOf("depth") && (d = !0), e = /^[0-9]+$/.test(b) ? a + "[" + b + "]" : c.isValidJavaScriptVariableName(b) ? a + "." + b : a + "['" + b + "']", 
                d ? "(" + a + " && " + e + ")" : e;
            },
            ...
            compile: function(a, b, c, d) {
                ...
                var e, f = a.opcodes;
                this.i = 0;
                for (var h = f.length; this.i < h; this.i++) e = f[this.i], "DECLARE" === e.opcode ? this[e.name] = e.value : this[e.opcode].apply(this, e.args), 
            ...
            popHash: function() {
                var a = this.hash;
                this.hash = void 0, this.options.stringParams && (this.register("hashContexts", "{" + a.contexts.join(",") + "}"), 
            ...
            invokeAmbiguous: function(a, b) {
                ...
                this.pushSource("if (" + f + " = " + d + ") { " + f + " = " + f + ".call(" + c.callParams + "); }"), 
                this.pushSource("else { " + f + " = " + e + "; " + f + " = typeof " + f + " === functionType ? " + f + ".call(" + c.callParams + ") : " + f + "; }");
            },
            ...
            programExpression: function(a) {
                ...
                for (var b, c = this.environment.children[a], d = c.depths.list, e = [ c.index, c.name, "data" ], f = 0, g = d.length; f < g; f++) b = d[f], 
            ...
            replaceStack: function(a) {
                var c, d = "", e = this.isInline();
                if (e) {
                    var f = this.popStack(!0);
                    if (f instanceof b) c = f.value; else {
                        var g = this.stackSlot ? this.topStackName() : this.incrStack();
                        d = "(" + this.push(g) + " = " + f + "),", c = this.topStack();
                    }
                } else c = this.topStack();
                var h = a.call(this, c);
                return e ? ((this.inlineStack.length || this.compileStack.length) && this.popStack(), 
                this.push("(" + d + h + ")")) : (/^stack/.test(c) || (c = this.nextStack()), this.pushSource(c + " = (" + d + h + ");")), 
                c;
            },
            nextStack: function() {
            ...
            popStack: function(a) {
                var c = this.isInline(), d = (c ? this.inlineStack : this.compileStack).pop();
                return !a && d instanceof b ? d.value : (c || this.stackSlot--, d);
            },
            topStack: function(a) {
                var c = this.isInline() ? this.inlineStack : this.compileStack, d = c[c.length - 1];
            ...
            setupParams: function(a, b, c) {
                ...
                g.push("fn:" + f));
                for (var j = 0; j < a; j++) d = this.popStack(), b.push(d), this.options.stringParams && (i.push(this.popStack()), 
        ...
        function f(a, b) {
            ...
            var c = j(a), d = new e().compile(c, b);
            return new k().compile(d, b);
        }
        function g(a, b, c) {
            function d() {
                var d = j(a), f = new e().compile(d, b), g = new k().compile(f, b, void 0, !0);
                return c.template(g);
            }
        ...
        var h = {}, i = a, j = b.parse, k = c, l = d;
        return h.Compiler = e, e.prototype = {
            compiler: e,
            disassemble: function() {
                for (var a, b, c, d = this.opcodes, e = [], f = 0, g = d.length; f < g; f++) if (a = d[f], 
            ...
            hash: function(a) {
                ...
                for (var e = 0, f = d.length; e < f; e++) b = d[e], c = b[1], this.options.stringParams ? (c.depth && this.addDepth(c.depth), 
