!function(a, b) {
    ...
    var c, d, e = {
        ...
        config: function(a, b) {
            ...
            "string" == typeof a.extend && (a.extend = [ a.extend ]), f.use("skin/layer.css", a.extend && a.extend.length > 0 ? function c() {
                var e = a.extend;
                f.use(e[e[d] ? d : d - 1], d < e.length ? function() {
                    return ++d, c;
                }() : b);
            }() : b), this;
        },
        use: function(a, b, d) {
            ...
            h.id = i, c("#" + i)[0] || e.appendChild(h), function a() {
