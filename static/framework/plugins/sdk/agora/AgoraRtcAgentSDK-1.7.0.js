...
AgoraRTC.macAgentInstallUrl = "http://download.agora.io/AgoraWebAgent-1.7.0.pkg";
AgoraRTC.winAgentInstallUrl = "http://download.agora.io/AgoraWebAgentSetup-1.7.0.exe";
...
AgoraRTC.Client = function (spec) {
        ...
        if (!that.signal) {
            ...
            function (event) {
                ...
                that.getVersion(function (ev) {
                    if (ev.version == "1.6.0" || ev.version == "1.6.1" || ev.version == "1.7.0") {
    ...
    that.renewChannelKey = function (channelKey, onSuccess, onFailure) {
        ...
        that.signal.on("renewChannelKey",
        function (ev) {
            var m = ev.msg;
            if (m.code === true) {
                AgoraCall(onSuccess, m);
    ...
    that.queryRecordingStatus = function (onStatus) {
        ...
        that.signal.on("queryRecordingStatus",
        function (ev) {
            onStatus(ev.msg)
        })
    };
    ...
    that.startScreenSharing = function (window, onSuccess, onFailure) {
        ...
        that.signal.on("startScreenSharing",
        function (e) {
    ...
    that.setScreenSharingWindow = function (window, onSuccess, onFailure) {
        ...
        that.signal.on("setScreenSharingWindow",
        function (e) {
            AgoraCall(onSuccess, e);
            console.log(e)
        })
    ...
    that.stopScreenSharing = function (onSuccess, onFailure) {
        ...
        that.signal.on("stopScreenSharing",
        function (e) {
            AgoraCall(onSuccess, e);
            console.log(e)
        })
