!function(a, b) {
    var c, d = {}, e = function(a, b) {
        ...
        for (c = [], d = a.length, e = 0; e < d; e++) c.push(h(a[e]));
    ...
    i(j), "object" == typeof module && "object" == typeof module.exports ? module.exports = j : "function" == typeof define && define.amd ? define([], j) : (c = a.WebUploader, 
    ...
    return b("dollar-third", [], function() {
        ...
        return {
            ...
            guid: function() {
                var a = 0;
                return function(b) {
                    for (var c = (+new Date()).toString(32), d = 0; d < 5; d++) c += Math.floor(65535 * Math.random()).toString(32);
        ...
        return c.options = {}, b.installTo(c.prototype), d.each({
            ...
            trigger: function(a) {
                ...
                return !(b.trigger.apply(this, arguments) === !1 || d.isFunction(e[f]) && e[f].apply(this, c) === !1 || d.isFunction(this[f]) && this[f].apply(this, c) === !1 || b.trigger.apply(b, [ this, a ].concat(c)) === !1);
            },
            request: a.noop
        ...
        function c(a, c) {
            var d = this;
            d.source = c, d.ruid = a, b.call(d, "Blob"), this.uid = c.uid || this.uid, this.type = c.type || "", 
            this.size = c.size || 0, a && d.connectRuntime(a);
        }
        return a.inherits(b, {
            constructor: c,
            slice: function(a, b) {
        ...
        function c(a, c) {
            var f;
            b.apply(this, arguments), this.name = c.name || "untitled" + d++, f = e.exec(c.name) ? RegExp.$1.toLowerCase() : "", 
            !f && this.type && (f = /\/(jpg|jpeg|png|gif|bmp)$/i.exec(this.type) ? RegExp.$1.toLowerCase() : "", 
            this.name += "." + f), !this.type && ~"jpg,jpeg,png,gif,bmp".indexOf(f) && (this.type = "image/" + ("jpg" === f ? "jpeg" : f)), 
            this.ext = f, this.lastModifiedDate = c.lastModifiedDate || new Date().toLocaleString();
        }
        var d = 1, e = /\.([^.]+)$/;
        ...
        function c(a) {
            ...
            return !(1 !== a.nodeType || !b) || ("array" === c || "function" !== c && "string" !== c && (0 === b || "number" == typeof b && b > 0 && b - 1 in a));
        }
        function d(a) {
        ...
        return e.extend(d.prototype, {
            ...
            request: function(b, d, e) {
                ...
                for (d = c(d) ? d : [ d ]; k < m; k++) f = l[k], h = f.invoke(b, d), h !== g && (a.isPromise(h) ? o.push(h) : n.push(h));
        ...
        return d = function(a) {
            ...
            compressImage: function(b) {
                ...
                if (b = this.request("get-file", b), g && ~"image/jpeg,image/jpg".indexOf(b.type) && !(b.size < h) && !b._compressed) return g = e.extend({}, g), 
                f = a.Deferred(), d = new c(g), f.always(function() {
                    ...
                    var a, c;
                    try {
                        a = d.getAsBlob(g.type), c = b.size, a.size < c && (b.source = a, b.size = a.size, 
        ...
        function d(a) {
            this.name = a.name || "Untitled", this.size = a.size || 0, this.type = a.type || "application", 
        ...
        return e.extend(d.prototype, {
            ...
            fetch: function(a) {
                ...
                for (a = a || f.QUEUED, b = 0; b < d; b++) if (c = this._queue[b], a === c.getStatus()) return c;
                return null;
            },
            sort: function(a) {
            ...
            getFiles: function() {
                for (var a, b = [].slice.call(arguments, 0), c = [], d = 0, f = this._queue.length; d < f; d++) a = this._queue[d], 
        ...
        return b.register({
            ...
            init: function(b) {
                ...
                if (g.isPlainObject(b.accept) && (b.accept = [ b.accept ]), b.accept) {
                    for (j = [], h = 0, e = b.accept.length; h < e; h++) i = b.accept[h].extensions, 
                    i && j.push(i);
                    j.length && (k = "\\." + j.join(",").replace(/,/g, "$|\\.").replace(/\*/g, ".*") + "$"), 
                    m.accept = new RegExp(k, "i");
                }
                if (m.queue = new c(), m.stats = m.queue.stats, "html5" === this.request("predict-runtime-type")) return d = a.Deferred(), 
                l = new f("Placeholder"), l.connectRuntime({
                    runtimeOrder: "html5"
                }, function() {
            ...
            _addFile: function(a) {
                var b = this;
                if (a = b._wrapFile(a), b.owner.trigger("beforeFileQueued", a)) return b.acceptFile(a) ? (b.queue.append(a), 
                b.owner.trigger("fileQueued", a), a) : void b.owner.trigger("error", "Q_TYPE_DENIED", a);
            },
            getFile: function(a) {
            ...
            retry: function(a, b) {
                ...
                for (c = f.queue.getFiles(i.ERROR), d = 0, e = c.length; d < e; d++) a = c[d], a.setStatus(i.QUEUED);
        ...
        return a.support = function() {
            ...
            predictRuntmeType: function() {
                ...
                if (!e) for (d = d.split(/\s*,\s*/g), a = 0, c = d.length; a < c; a++) if (b.hasRuntime(d[a])) {
                    this.type = e = d[a];
                    break;
                }
                return e;
        ...
        function e(a, b) {
            for (var c, d = [], e = a.source, f = e.size, g = b ? Math.ceil(f / b) : 1, h = 0, i = 0; i < g; ) c = Math.min(b, f - h), 
            d.push({
                file: a,
                start: h,
                end: b ? h + c : f,
        ...
        f.extend(b.options, {
            ...
            init: function() {
                var b = this.owner;
                this.runing = !1, this.pool = [], this.pending = [], this.remaning = 0, this.__tick = a.bindFn(this._tick, this), 
            ...
            _nextBlock: function() {
                ...
                a = c.pending.shift(), b = function(a) {
            ...
            _prepareNextFile: function() {
                ...
                c && (a = b.request("before-send-file", c, function() {
                    return c.getStatus() === h.QUEUED ? (b.owner.trigger("uploadStart", c), c.setStatus(h.PROGRESS), 
                    c) : b._finishFile(c);
                }), a.done(function() {
                    var b = f.inArray(a, d);
                    ~b && d.splice(b, 1, c);
            ...
            _startSend: function(b) {
                ...
                d.pool.push(b), d.remaning++, b.blob = 1 === b.chunks ? e.source : e.source.slice(b.start, b.end), 
        ...
        function e() {
            ...
            c.apply(d, arguments), d.type = f, d.exec = function(c, e) {
                ...
                if (g[c] && (f = a[i] = a[i] || new g[c](h, d), f[e])) return f[e].apply(f, j);
            }, d.destory = function() {
        ...
        return b.register("FilePicker", {
            init: function() {
                ...
                j.on("click", function() {
                    ...
                    for (a = [], b = 0, d = i.accept.length; b < d; b++) a.push(i.accept[b].mimeTypes);
                ...
                f.append(k), f.append(j), e = function(a) {
                    ...
                    g.files = a.target.files, b = this.cloneNode(!0), this.parentNode.replaceChild(b, this), 
            ...
            _parse: function(a, c) {
                if (!(a.byteLength < 6)) {
                    ...
                    if (65496 === h.getUint16(0)) {
                        for (;i < j && (d = h.getUint16(i), d >= 65504 && d <= 65519 || 65534 === d) && (e = h.getUint16(i + 2) + 2, 
                        !(i + e > h.byteLength)); ) {
        ...
        return c.ExifMap = function() {
            ...
            for (k = [], l = 0; l < g; l += 1) k[l] = o.getValue(b, j + l * o.size, h);
            if (o.ascii) {
            ...
            for (i = 0; i < g; i += 1) this.parseExifTag(b, c, d + 2 + 12 * i, e, f);
        ...
        return b.register("Image", {
            ...
            _renderImageToCanvas: function() {
                ...
                function c(a) {
                    ...
                    c = b.getContext("2d"), c.drawImage(a, -d + 1, 0), 0 === c.getImageData(0, 0, 1, 1).data[3]);
                }
                return a.os.ios ? a.os.ios >= 7 ? function(a, c, d, e, f, g) {
                    ...
                    j = i.getContext("2d"), k = t ? b(d, p, q) : 1, l = Math.ceil(u * g / p), m = Math.ceil(u * h / q / k); v < q; ) {
                        for (n = 0, o = 0; n < p; ) j.clearRect(0, 0, u, u), j.drawImage(d, -n, -v), r.drawImage(i, 0, 0, u, u, e + o, f + w, l, m), 
                        n += u, o += l;
                        v += u, w += m;
                    }
                    r.restore(), i = j = null;
    ...
    }), b("runtime/html5/jpegencoder", [], function(a, b, c) {
        function d(a) {
            function b(a) {
                for (var b = [ 16, 11, 10, 16, 24, 40, 51, 61, 12, 12, 14, 19, 26, 58, 60, 55, 14, 13, 16, 24, 40, 57, 69, 56, 14, 17, 22, 29, 51, 87, 80, 62, 18, 22, 37, 56, 68, 109, 103, 77, 24, 35, 55, 64, 81, 104, 113, 92, 49, 64, 78, 87, 103, 121, 120, 101, 72, 92, 95, 98, 112, 100, 103, 99 ], c = 0; c < 64; c++) {
                    var d = y((b[c] * a + 50) / 100);
                    d < 1 ? d = 1 : d > 255 && (d = 255), z[P[c]] = d;
                }
                for (var e = [ 17, 18, 24, 47, 99, 99, 99, 99, 18, 21, 26, 66, 99, 99, 99, 99, 24, 26, 56, 99, 99, 99, 99, 99, 47, 66, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99 ], f = 0; f < 64; f++) {
                    var g = y((e[f] * a + 50) / 100);
                    g < 1 ? g = 1 : g > 255 && (g = 255), A[P[f]] = g;
                }
                for (var h = [ 1, 1.387039845, 1.306562965, 1.175875602, 1, .785694958, .5411961, .275899379 ], i = 0, j = 0; j < 8; j++) for (var k = 0; k < 8; k++) B[i] = 1 / (z[P[i]] * h[j] * h[k] * 8), 
                C[i] = 1 / (A[P[i]] * h[j] * h[k] * 8), i++;
            }
            function c(a, b) {
                for (var c = 0, d = 0, e = new Array(), f = 1; f <= 16; f++) {
            ...
            function e() {
                for (var a = 1, b = 2, c = 1; c <= 15; c++) {
                    for (var d = a; d < b; d++) E[32767 + d] = c, D[32767 + d] = [], D[32767 + d][1] = c, 
                    D[32767 + d][0] = d;
                    for (var e = -(b - 1); e <= -a; e++) E[32767 + e] = c, D[32767 + e] = [], D[32767 + e][1] = c, 
                    D[32767 + e][0] = b - 1 + e;
                    a <<= 1, b <<= 1;
                }
            }
            function f() {
                for (var a = 0; a < 256; a++) O[a] = 19595 * a, O[a + 256 >> 0] = 38470 * a, O[a + 512 >> 0] = 7471 * a + 32768, 
            ...
            function g(a) {
                ...
                J < 0 && (255 == I ? (h(255), h(0)) : h(I), J = 7, I = 0);
            }
            function h(a) {
                H.push(N[a]);
            }
            ...
            function j(a, b) {
                ...
                var _;
                for (k = 0; k < n; ++k) _ = a[k] * b[k], F[k] = _ > 0 ? _ + .5 | 0 : _ - .5 | 0;
                return F;
            }
            function k() {
            ...
            function m() {
                i(65499), i(132), h(0);
                for (var a = 0; a < 64; a++) h(z[a]);
                h(1);
                for (var b = 0; b < 64; b++) h(A[b]);
            }
            function n() {
                i(65476), i(418), h(0);
                for (var a = 0; a < 16; a++) h(Q[a + 1]);
                for (var b = 0; b <= 11; b++) h(R[b]);
                h(16);
                for (var c = 0; c < 16; c++) h(S[c + 1]);
                for (var d = 0; d <= 161; d++) h(T[d]);
                h(1);
                for (var e = 0; e < 16; e++) h(U[e + 1]);
                for (var f = 0; f <= 11; f++) h(V[f]);
                h(17);
                for (var g = 0; g < 16; g++) h(W[g + 1]);
                for (var j = 0; j <= 161; j++) h(X[j]);
            }
            function o() {
                i(65498), i(12), h(3), h(1), h(0), h(2), h(17), h(3), h(17), h(0), h(63), h(0);
            }
            function p(a, b, c, d, e) {
                for (var f, h = e[0], i = e[240], k = 16, l = 63, m = 64, n = j(a, b), o = 0; o < m; ++o) G[P[o]] = n[o];
                var p = G[0] - c;
                c = G[0], 0 == p ? g(d[0]) : (f = 32767 + p, g(d[E[f]]), g(D[f]));
                for (var q = 63; q > 0 && 0 == G[q]; q--) ;
                if (0 == q) return g(h), c;
                for (var r, s = 1; s <= q; ) {
                    for (var t = s; 0 == G[s] && s <= q; ++s) ;
                    var u = s - t;
                    if (u >= k) {
                        r = u >> 4;
                        for (var v = 1; v <= r; ++v) g(i);
                        u = 15 & u;
                    }
            ...
            function q() {
                for (var a = String.fromCharCode, b = 0; b < 256; b++) N[b] = a(b);
            }
            function r(a) {
                if (a <= 0 && (a = 1), a > 100 && (a = 100), x != a) {
                    var c = 0;
                    c = a < 50 ? Math.floor(5e3 / a) : Math.floor(200 - 2 * a), b(c), x = a;
                }
            }
            function s() {
                a || (a = 50), q(), d(), e(), f(), r(a);
            ...
            this.encode = function(a, b) {
                ...
                for (var f, h, j, q, s, x, y, z, A, D = a.data, E = a.width, F = a.height, G = 4 * E, N = 0; N < F; ) {
                    for (f = 0; f < G; ) {
                        for (s = G * N + f, x = s, y = -1, z = 0, A = 0; A < 64; A++) z = A >> 3, y = 4 * (7 & A), 
        ...
        return b.register("Transport", {
            ...
            send: function() {
                ...
                c ? (h.overrideMimeType("application/octet-stream"), a.os.android ? (e = new FileReader(), 
                e.onload = function() {
            ...
            _initAjax: function() {
                ...
                b.upload.onprogress = function(b) {
                    ...
                    if (4 === b.readyState) return b.upload.onprogress = c, b.onreadystatechange = c, 
                    ...
                    a.trigger("error", "server")) : a.trigger("error", a._status ? "http" : "abort");
                }, a._xhr = b, b;
            },
    ...
    return b("dollar-third", [], function() {
        ...
        return d = {
            ...
            d && a.on("beforeFileQueued", function(a) {
                if (a.size > d) return a.setStatus(c.Status.INVALID, "exceed_size"), this.trigger("error", "F_EXCEED_SIZE", a), 
                !1;
            });
        }), d.addValidator("duplicate", function() {
            function a(a) {
                for (var b, c = 0, d = 0, e = a.length; d < e; d++) b = a.charCodeAt(d), c = b + (c << 6) + (c << 16) - c;
                return c;
            }
            ...
            c.duplicate || (b.on("beforeFileQueued", function(b) {
                ...
                if (d[c]) return this.trigger("error", "F_DUPLICATE", b), !1;
        ...
        return b.register("FilePicker", {
            init: function(a) {
                ...
                for (b = e.accept && e.accept.length, d = 0; d < b; d++) e.accept[d].title || (e.accept[d].title = "Files");
        ...
        return b.register("Transport", {
            ...
            send: function() {
                ...
                e.connectRuntime(f.ruid), c.sendAsBinary ? (g += (/\?/.test(g) ? "&" : "?") + d.param(b._formData), 
                a = f.uid) : (d.each(b._formData, function(a, b) {
                    e.exec("append", a, b);
                }), e.exec("appendBlob", c.fileVal, f.uid, c.filename || b._formData.name || "")), 
                this._setRequestHeader(e, c.headers), e.exec("send", {
                    method: c.method,
                    url: g
                }, a);
            },
            ...
            _initAjax: function() {
                ...
                return b.on("uploadprogress progress", function(b) {
                    ...
                    return b.off(), a._xhr = null, c >= 200 && c < 300 ? (a._response = b.exec("getResponse"), 
                    a._responseJson = b.exec("getResponseAsJson")) : c >= 500 && c < 600 ? (a._response = b.exec("getResponse"), 
                    a._responseJson = b.exec("getResponseAsJson"), d = "server") : d = "http", b.destroy(), 
                    b = null, d ? a.trigger("error", d) : a.trigger("load");
                }), b.on("error", function() {
    ...
    return b("dollar-third", [], function() {
        ...
        return b.register("DragAndDrop", {
            ...
            _dragOverHandler: function(a) {
                ...
                return !(b && !d.contains(b, a.currentTarget)) && (clearTimeout(this._leaveTimer), 
            ...
            _dropHandler: function(a) {
                ...
                return !(g && !d.contains(g, a.currentTarget)) && (b._getTansferFiles(a, function(a) {
            ...
            _getTansferFiles: function(b, c) {
                ...
                for (b = b.originalEvent || b, f = b.dataTransfer, d = f.items, e = f.files, k = !(!d || !d[0].webkitGetAsEntry), 
                i = 0, j = e.length; i < j; i++) g = e[i], h = d && d[i], k && h.webkitGetAsEntry().isDirectory ? m.push(this._traverseDirectoryTree(h.webkitGetAsEntry(), l)) : l.push(g);
            ...
            _traverseDirectoryTree: function(b, c) {
                ...
                return b.isFile ? b.file(function(a) {
                    ...
                    for (f = 0; f < g; f++) h.push(e._traverseDirectoryTree(b[f], i));
            ...
            destroy: function() {
                var a = this.elem;
                a.off("dragenter", this.dragEnterHandler), a.off("dragover", this.dragEnterHandler), 
        ...
        return b.register("FilePaste", {
            init: function() {
                ...
                if (f.accept) {
                    for (b = [], c = 0, d = f.accept.length; c < d; c++) e = f.accept[c].mimeTypes, 
                    e && b.push(e);
            ...
            _pasteHander: function(a) {
                ...
                for (a = a.originalEvent || a, b = a.clipboardData.items, f = 0, g = b.length; f < g; f++) d = b[f], 
