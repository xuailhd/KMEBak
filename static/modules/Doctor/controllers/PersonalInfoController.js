...
define(["jquery",
        ...
        "module-directive-form-control-editor",
          ...
          "ngAnimate"]);
            ...
            app.controller('PersonalInfoController', [
                ...
                function ($scope, $http, $q, $location, $state, $translate, $filter, webapiServices) {
                    ...
                    $scope.Data = {};
                    $scope.load = function () {
                        webapiServices.getDoctorInfo(null,
                            function (response) {
                    ...
                    $('#filePhotoUrl').change(function () {
                        ...
                        if ($.trim(obj.value) != '') {
                            ...
                            UploadFile(obj, 'UserPhotos', function (data) {
                                ...
                                $scope.Data.PhotoFullUrl = global_StoreConfig.UrlPrefix + '/' + data.FileName;
                                $scope.$apply();
                            })
                        }
                    });
                    ...
                    $scope.save = function () {
                        webapiServices.updateDoctorInfo($scope.Data,
                        function (response) {
                            if (response.Status == 0) {
                                layer.msg("保存成功");
